...
//
// Ported from upstream (crosspoint feat/library-view); the non-touch row
// height comes from uiListRowHeight() (UI-scale aware) instead of the raw
// theme metrics, which is this fork's established idiom.
